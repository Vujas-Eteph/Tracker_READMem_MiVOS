...
from MiVOS.model.propagation.modules import *
...
class EvalMemoryReader(nn.Module):
    ...
    def compute_similarites_for_memory_key_types(self, mk, qk):
        B, CK, T, H, W = mk.shape
        ...
        affinity_v2 = F.softmax(affinity.clone(), dim=1)
    ...
    def forward(self, mk, mv, qk):
        ...
        self.base_affinity = affinity.clone()

        #self.affinity = softmax_w_g_top(affinity.clone(), top=None, gauss=None) .clone()
        ...
        self.weighted_affinity = affinity.clone()

        return mem

    def get_affinity(self):
        return self.weighted_affinity, self.base_affinity
...
class PropagationNetwork(nn.Module):
    ...
    def compute_similarites_for_memory_key_types(self, mk, qk):
        return self.memory.compute_similarites_for_memory_key_types(mk,qk)
